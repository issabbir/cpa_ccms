            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST"  action="@if ($data && $data->requisition_dtl_no) {{route('admin.requisition-details.update',['requisition_mst_no'=>$requisitionMaster->requisition_mst_no,'id' => $data->requisition_dtl_no])}}
                        @else {{route('admin.requisition-details.create',['requisition_mst_no'=>$requisitionMaster->requisition_mst_no])}} @endif">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="input-required" style="margin-top: 8px">Replacement yn<span class="required"></span></label>
                    ...
                    <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            <table class="table table-sm datatable"
                             data-url="{{ route('admin.requisition-details-datatable.data',['requisition_mst_no'=>$requisitionMaster->requisition_mst_no])}}"
