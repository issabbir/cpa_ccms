        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-info btn-sm show-modal">Assign</button>
                </div><hr>
                <div class="card-body">
                    <div class="row mb-1">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->ticket_id }}"
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->ticket_type_no }}"
                                           class="form-control text-uppercase">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->ticket_priority_no }}"
                                           class="form-control text-uppercase">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->occurance_date }}"
                                           class="form-control text-uppercase">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->meeting_start_time }}"
                                           class="form-control text-uppercase">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly value="{{ $getTicketDetls->meeting_end_time }}"
                                           class="form-control text-uppercase">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="" id="" readonly class="form-control text-uppercase"
                                      title="{{ $getTicketDetls->ticket_description }}" style="height: 37px" >{{ $getTicketDetls->ticket_description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              ...
              <form method="POST" action=" @if ($data && $data->ticket_no) {{route('ticket_assign.update',['id' => $data->ticket_no])}} @else {{route('ticket_assign.store')}} @endif"> {{ ($data && isset($data->ticket_no))?method_field('PUT'):'' }}
              {!! csrf_field() !!}
          ...
          <div class="card">
              ...
              <div class="col-md-8" style="margin-left: 15%">
                <div class="card-body comment-widgets">
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row m-t-0 pr-5 pl-5">
                        ...
                        <div class="comment-text w-100">
                            <div class="row d-flex justify-content-between">
                              ...
                              <span class="text-muted pr-1">April 14, 2019</span>
                            </div><hr style="margin-top: 0">
                            <span class="m-b-15 d-block">This is awesome website. I would love to comeback again. </span>
                        </div>
                    </div> <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row pr-5 pl-5">
                        <div class="comment-text active w-100">
                            <div class="row d-flex justify-content-between">
                              <span class="ml-1 font-medium">
                                <h6>Michael Hussey</h6>
                              </span>
                              <span class="text-muted pr-1">May 10, 2019</span>
                            </div><hr style="margin-top: 0">
                    ...
                    <div class="d-flex flex-row comment-row pr-5 pl-5">
                        ...
                        <div class="comment-text w-100">
                            <div class="row d-flex justify-content-between">
                              <span class="ml-1 font-medium">
                                <h6>Johnathan Doeting</h6>
                              </span>
                              <span class="text-muted pr-1">August 1, 2019</span>
                            </div><hr style="margin-top: 0;">
