...
<head>
    ...
    <title>CPA Computer equipment and peripherals maintenance system  @yield('title', 'CPA Database Management System in Security Department')</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/watchman.css')}}">
    <!-- END: Page CSS-->
